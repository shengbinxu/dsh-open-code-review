...
export function resolvePreview(request, cwd) {
    return {
...
export function resolveRules(request, cwd) {
    return {
        repoRoot: resolveRepo(request.repo, cwd),
